...
export default function MasterTable() {
      ...
      renderCell: (params) => {
        ...
        return (
          <div className="">
            ...
            <IconButton onClick={() => handleView(auctionData?.id,auctionData)}>
  ...
  const filteredRows = data.filter(
    (row) =>
      ...
      filterString(row.auctionResult, filterText) ||
      filterString(row.bulkbid, filterText) ||
      filterString(row.proxybid, filterText) ||
      filterString(row.popcornbid, filterText) ||
      ...
      filterNumber(row.bulkbid, filterText) ||
      filterNumber(row.proxybid, filterText) ||
      filterNumber(row.popcornbid, filterText) ||
